...
<body>
	...
	<div class="container">
		<div id="button" class="mt10">
			<form id="mstInfoForm" name="mstInfoForm" method="post">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td>属性名称：</td>
						<td><input type="text" class="input-text lh30" size="45"
							name="m_name" id="m_name" value="${m_name}"></td>
						<td>属性类型：</td>
						<td><input type="text" class="input-text lh30" size="45"
							name="m_type_name" id="m_type_name" value="${m_type_name}">
						</td>
					</tr>

					<tr>
						<td colspan="4" class="td_right"><input type="button"
							name="button" onclick="mstSearch()" class="btn btn82 btn_search"
							value="查询"></td>
					</tr>
				</table>
		...
		<input type="button" name="button" class="btn btn82 btn_add"
			...
			onclick="mstToAdd();return false;" value="新增">
							...
							<c:forEach var="mst" items="${list.list}">
								<tr class="tr">
									...
									<td class="td_center">&nbsp;&nbsp; <input type="button"
										...
										onclick="mstToUpdate('${mst.M_CODE}');return false"
										value="编辑">
									</td>
									<td class="td_center"><input type="button" name="button"
										class="btn btn82 btn_del"
										onclick="javascript:Dialog.confirm('警告：您确认要删除（${mst.M_NAME}）该产品吗？',function(){mstDelete(${mst.M_CODE})});"
										value="删除"></td>
								</tr>
							</c:forEach>
						</c:if>
					...
					<div class="page mt10">
						<div class="pagination">
							...
							<c:set var="pageUrl" scope="request"
								value="admin/masertInfo/mstList.json?pageNum=" />
