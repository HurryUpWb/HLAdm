...
<div class="container">
    ...
    <div id="search_bar" class="mt10">
        <form id="westSearch" name="westSearch" method="post" action="admin/adminOrderSearch/WestSearch.json">
            <!-- 查询条件 -->
                        ...
                        <c:choose>
                            ...
                            <c:when test="${Authority=='5'}">
                             ...
                             <c:when test="${Authority=='6'}">
                            		<option <c:if test="${ORDER_TYPE =='10' }">selected</c:if> value="10">西部航空</option>
                            </c:when>
                        </c:choose>
                    </select>
                    </td>
            ...
            <div id="button" class="mt10"><input type="button"
                                                 onclick="westOrderInquiry(${currentFunc});" name="searchBtn"
                                                 class="btn btn82 btn_search" value="查询"> &nbsp;&nbsp;<input
                    type="button" onclick="AutomateExcel('66');" name="exportBtn"
                        ...
                        <c:forEach var="list" items="${pageList.list }">
                            <tr>
                                ...
                                <th width="8%"><c:if test="${list.ORDER_TYPE=='5' }">PC端</c:if><c:if
                                    ...
                                    <c:if test="${list.ORDER_TYPE=='10' }">西部航空</c:if>
                                </th>
                                <th width="8%">
                                ...
                                <th width="6%"><input type="button" onclick="CheckWestDetail('${list.TRANS_NO}')"
            ...
            <c:if test="${pageList.totalRow>0}">
                <div class="page mt10">
                    <div class="pagination">
                        ...
                        <c:set var="formName" scope="request" value="westSearch"/>
                        <c:set var="pageUrl" scope="request" value="admin/adminOrderSearch/WestSearch.json?pageIndex="/>
