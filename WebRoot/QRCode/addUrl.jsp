...
<body>
<div class="container">
    <a href="<%=basePath%>admin/QRCode/manageURL.json?id=${id}"><input type="button" name="button" class="btn btn82 btn_save2" value="返回"></a>
    <br/>
    <div class="mt10">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="search_table">
            <form action="<%=basePath%>admin/QRCode/addUrlSave.json" method="post">
                <input type="hidden" name="companyID" value="${id}">
                <input type="hidden" name="url" id="urlHidden" value="">
                <tr>
                    <td colspan="2" bgcolor="#eeeeee"><label style="font-weight:bold; font-size:14px;">新增URL</label></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="url" value="" class="input-text lh30" size="45" />&nbsp;&nbsp;<font color="red">*</font>
                    </td>
                </tr>
            </form>
            <tr>
